...
var con_mysql = mysql.createPool({
    host: "localhost",
    user: "findnseekjobs_live_user",
    password: "J9j,jk&q_#5G",
    database: "findnseekjobs_live_db",
    debug: true,
    charset:'utf8mb4'
});

var FCM = require('fcm-node');
var serverKey = 'AAAAs94xrWo:APA91bHvckSm-23tuJMGbB4C9bx6wGDQJLMi6vC4w_W0RtWIHMTeQCwcFuke0giw5RWT9QeHSmybGmF9ug8rZ-GbpR9JjQz4nQO0DGcJCGJ2YjFbTsHS6DfLcl3-edFop04H70cJ0Y6A'; //put your server key here
