...
if (!function_exists('makeThumbnail')) {
    ...
    function makeThumbnail($video_name) 
    {
        ...
        $thumbnail = getcwd() . "/public/thumb/" . $file_thumb_image;
        $cmd = sprintf('ffmpeg -i %s -ss %s -f image2 -vframes 1 %s', $video_name, 02, $thumbnail);
        exec($cmd);
        // return "https://server.appsstaging.com/3346/findnseek/public/thumb/" . $file_thumb_image;
        return "http://findnseekjobs.com/webservices/public/thumb/" . $file_thumb_image;
    }
}
